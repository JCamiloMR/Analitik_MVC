...
export function Dashboard({ type = 'ventas', isDarkMode = false }: DashboardProps) {
  ...
  const salesByCategoryData = [
    { category: 'Uniformes', ventas: 52300 },
    { category: 'Casual', ventas: 43800 },
    { category: 'Formal', ventas: 28490 }
  ];

  const recentOrdersData = [
    { id: '#ORD-1234', cliente: 'Empresa ABC S.A.', monto: '$15,500', categoria: 'Uniformes', estado: 'Completado' },
    { id: '#ORD-1235', cliente: 'Comercial GHI', monto: '$8,200', categoria: 'Casual', estado: 'Pendiente' },
    { id: '#ORD-1236', cliente: 'Corporación XYZ', monto: '$12,800', categoria: 'Formal', estado: 'Completado' },
    { id: '#ORD-1237', cliente: 'Industrias DEF', monto: '$9,500', categoria: 'Uniformes', estado: 'Procesando' },
    { id: '#ORD-1238', cliente: 'Distribuidora JKL', monto: '$6,300', categoria: 'Casual', estado: 'Completado' },
    { id: '#ORD-1239', cliente: 'Empresa ABC S.A.', monto: '$18,900', categoria: 'Uniformes', estado: 'Completado' },
    { id: '#ORD-1240', cliente: 'Comercial GHI', monto: '$5,700', categoria: 'Formal', estado: 'Pendiente' },
    { id: '#ORD-1241', cliente: 'Corporación XYZ', monto: '$11,200', categoria: 'Casual', estado: 'Completado' },
    { id: '#ORD-1242', cliente: 'Industrias DEF', monto: '$14,500', categoria: 'Uniformes', estado: 'Procesando' },
    { id: '#ORD-1243', cliente: 'Distribuidora JKL', monto: '$7,800', categoria: 'Formal', estado: 'Completado' }
  ];

  // ==================== INVENTARIOS DATA ====================
  const inventoryLevelData = [
    { category: 'Uniformes', nivel: 850, status: 'high' },
    { category: 'Casual', nivel: 420, status: 'normal' },
    { category: 'Formal', nivel: 680, status: 'high' },
    { category: 'Accesorios', nivel: 290, status: 'low' },
    { category: 'Insumos', nivel: 540, status: 'normal' }
  ];
  ...
  const inventoryMovementsData = [
    { month: 'Abr', entradas: 520, salidas: 480 },
    { month: 'May', entradas: 580, salidas: 540 },
    { month: 'Jun', entradas: 490, salidas: 510 },
    { month: 'Jul', entradas: 640, salidas: 590 },
    { month: 'Ago', entradas: 560, salidas: 620 },
    { month: 'Sep', entradas: 610, salidas: 580 }
  ];
      ...
      case 'inventarios':
        return [
          { 
            ...
            trend: 'up', 
            icon: Package,
            description: 'Cuántos días alcanza el inventario con el ritmo de ventas actual.',
            linkText: 'Ver gráfico por categoría',
            relatedChart: 'inventory-level'
          },
          { 
            title: 'Inventario vendido del mes (%)', 
            value: '80%', 
            change: 'Buena', 
            trend: 'up', 
            icon: TrendingUp,
            description: 'Porción del inventario que ya se vendió este mes.',
          ...
          { 
            ...
            trend: 'down', 
            icon: AlertTriangle,
            description: 'Inventario que no se mueve y estanca plata.',
            linkText: 'Ver productos sin movimiento',
            relatedChart: 'no-movement'
          },
          { 
            ...
            trend: 'down', 
            icon: AlertCircle,
            description: 'Productos cerca de agotarse que requieren reabastecer.',
            linkText: 'Ver gráfico de rotación',
              ...
              <>
                ...
                >
                  <Card id="movements" className="bg-white dark:bg-[#273043] border-slate-200 dark:border-[#374151] hover:shadow-lg transition-all duration-200 rounded-xl">
                    ...
                    <CardContent>
                      <ResponsiveContainer width="100%" height={300}>
                        <BarChart data={inventoryMovementsData}>
                          <CartesianGrid strokeDasharray="3 3" stroke="#374151" />
                          <XAxis dataKey="month" stroke={axisColor} />
                          <YAxis stroke={axisColor} />
                          <RechartsTooltip content={<CustomTooltip formatter={(value: number) => `${value} unidades`} />} />
                ...
                >
                  <Card id="rotation" className="bg-white dark:bg-[#273043] border-slate-200 dark:border-[#374151] hover:shadow-lg transition-all duration-200 rounded-xl">
                    ...
                    <CardContent>
                      <ResponsiveContainer width="100%" height={300}>
                        <BarChart data={rotationByProductData} layout="vertical">
                          <CartesianGrid strokeDasharray="3 3" stroke="#374151" />
                          ...
                          <Bar dataKey="rotacion" name="Rotación" radius={[0, 4, 4, 0]}>
                            {rotationByProductData.map((entry, index) => (
              ...
              <>
                ...
                >
                  <Card id="efficiency" className="bg-white dark:bg-[#273043] border-slate-200 dark:border-[#374151] hover:shadow-lg transition-all duration-200 rounded-xl">
                    ...
                    <CardContent>
                      <ResponsiveContainer width="100%" height={300}>
                        <BarChart data={efficiencyByShiftData}>
                          <CartesianGrid strokeDasharray="3 3" stroke="#374151" />
                ...
                >
                  <Card id="waste" className="bg-white dark:bg-[#273043] border-slate-200 dark:border-[#374151] hover:shadow-lg transition-all duration-200 rounded-xl">
                    ...
                    <CardContent>
                      <ResponsiveContainer width="100%" height={300}>
                        <BarChart data={wasteDetailData} layout="vertical">
                          <CartesianGrid strokeDasharray="3 3" stroke="#374151" />
                          <XAxis type="number" stroke={axisColor} tickFormatter={(value) => `$${value / 1000}K`} />
                ...
                >
                  <Card id="times" className="bg-white dark:bg-[#273043] border-slate-200 dark:border-[#374151] hover:shadow-lg transition-all duration-200 rounded-xl">
                    ...
                    <CardContent>
                      <ResponsiveContainer width="100%" height={300}>
                        <BarChart data={processStageTimes}>
                          <CartesianGrid strokeDasharray="3 3" stroke="#374151" />
              ...
              <>
                ...
                >
                  <Card id="expenses" className="bg-white dark:bg-[#273043] border-slate-200 dark:border-[#374151] hover:shadow-lg transition-all duration-200 rounded-xl">
                    ...
                    <CardContent>
                      <ResponsiveContainer width="100%" height={300}>
                        <BarChart data={expenseDistributionData} layout="vertical">
                          <CartesianGrid strokeDasharray="3 3" stroke="#374151" />
                ...
                >
                  <Card id="profitability" className="bg-white dark:bg-[#273043] border-slate-200 dark:border-[#374151] hover:shadow-lg transition-all duration-200 rounded-xl">
                    ...
                    <CardContent>
                      <ResponsiveContainer width="100%" height={300}>
                        <AreaChart data={profitabilityEvolutionData}>
                          <CartesianGrid strokeDasharray="3 3" stroke="#374151" />
