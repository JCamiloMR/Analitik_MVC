...
???????????????????????????????????????????????????????????????
?                     FRONTEND (React)                        ?
?              DataLoadingPanel.tsx (ya existente)            ?
???????????????????????????????????????????????????????????????
...
?  ??????????????????????????????????????????????????????    ?
?  ? NIVEL 1: ValidarArchivoExcel                       ?    ?
?  ? - Extensión .xlsx                                  ?    ?
?  ? - Tamaño < 10 MB                                   ?    ?
?  ? - Archivo válido                                   ?    ?
?  ??????????????????????????????????????????????????????    ?
?  ??????????????????????????????????????????????????????    ?
?  ? NIVEL 2: ValidarEstructuraHojas                    ?    ?
?  ? - 4 hojas: PRODUCTOS, INVENTARIO, VENTAS, FINANC   ?    ?
?  ? - Columnas obligatorias presentes                  ?    ?
?  ??????????????????????????????????????????????????????    ?
?  ??????????????????????????????????????????????????????    ?
?  ? NIVEL 3: LeerYMapear (ExcelReaderService)          ?    ?
?  ? - Parse de datos con validaciones de negocio      ?    ?
?  ? - Conversión a DTOs                                ?    ?
?  ??????????????????????????????????????????????????????    ?
?  ??????????????????????????????????????????????????????    ?
?  ? NIVEL 4: Carga Atómica (DatabaseLoaderService)     ?    ?
?  ? - Transacción SERIALIZABLE                         ?    ?
?  ? - Upsert de productos                              ?    ?
?  ? - Insert de inventario, ventas, financieros        ?    ?
?  ? - COMMIT o ROLLBACK                                ?    ?
?  ??????????????????????????????????????????????????????    ?
?  ??????????????????????????????????????????????????????    ?
?  ? NIVEL 5: Logs (ImportLogService)                   ?    ?
?  ? - Registro en tabla importaciones_datos            ?    ?
